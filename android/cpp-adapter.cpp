...
// Automated testing checks Java_com_skychatlib_SkychatLibModule and skychatlib
...
// Installer coming from SkychatLibModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_skychatlib_SkychatLibModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return skychatlib::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_skychatlib_SkychatLibModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return skychatlib::cleanupRustCrate(*runtime);
}